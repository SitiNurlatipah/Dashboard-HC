...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default card-view">
            ...
            <button class="btn btn-primary btn-lable-wrap left-label btn-sm"  data-toggle="modal" data-target="#add-mppreal" data-whatever="@mdo"> <span class="btn-label"><i class="fa fa-pencil"></i> </span><span class="btn-text">Add Data</span></button>
                        <div class="table-wrap">
                            <div class="table-responsive">
                                <table id="mpprealTable" class="table table-hover table-bordered display mb-30 text-center" >
                                    <thead>
                                    <tr>
...
<!-- end add data -->
@foreach($mpp_vs_realization as $mppreal)
