                            ...
                            <form class="form-inline mb-30 mt-30">
                                <div class="form-group mr-15">
                                    ...
                                    <select class="form-control">
                                        <option>Locator 1</option>
                                        <option>Locator 2</option>
                                        <option>Locator 3</option>
                                        <option>Locator 4</option>
                                        <option>Locator 5</option>
                                    </select>
                                </div>
                                <div class="form-group mr-15">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body sm-data-box-1">
                        ...
                        <div class="progress-anim mt-20">
                            <div class="progress">
                                <div class="progress-bar progress-bar-success wow animated progress-animated" role="progressbar" aria-valuenow="40.13" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
            ...
            <div class="panel panel-default card-view panel-refresh relative">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <div id="e_chart_2" class="" style="height:367px;"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-default card-view">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div id="e_chart_4" class="" style="height:197px;"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="panel panel-default card-view">
                        ...
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div id="e_chart_1" class="" style="height:401px;"></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    let pahoConfig = {
        hostname: "broker.mqttdashboard.com",  //The hostname is the url, under which your FROST-Server resides.
    ...
    client.subscribe("test/topic/start");
    }
